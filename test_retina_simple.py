...
def test_retina_solver_dependencies():
    ...
    for required_file in required_files:
        assert required_file in available_files, f"Missing required file: {required_file}"
...
def test_missing_radar_config(solver, radar_config):
    ...
    detections = {
        'test_aircraft': [
            {'radar': 'nonexistent_radar', 'timestamp': 1641024000, 'delay': 35.0, 'doppler': 200.0},
            {'radar': 'adelaideHills', 'timestamp': 1641024000, 'delay': 40.0, 'doppler': 220.0},
            {'radar': 'northAdelaide', 'timestamp': 1641024000, 'delay': 32.0, 'doppler': 180.0}
        ]
    }
