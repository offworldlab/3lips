...
class TestRETINASolverLocalisation:
    ...
    def test_successful_localization(self, mock_detection, mock_triple, mock_initial_guess, mock_solver):
        mock_detection.return_value = Mock()
        mock_triple.return_value = Mock()
        mock_initial_guess.return_value = {"lat": -34.9295, "lon": 138.6005, "alt": 1000}
    ...
    @patch('algorithm.localisation.RETINASolverLocalisation.DetectionTriple')
    @patch('algorithm.localisation.RETINASolverLocalisation.Detection')
    def test_solver_failure_handling(self, mock_detection, mock_triple, mock_initial_guess, mock_solver):
        mock_detection.return_value = Mock()
        mock_triple.return_value = Mock()
        mock_initial_guess.return_value = {"lat": -34.9295, "lon": 138.6005, "alt": 1000}
    ...
    @patch('algorithm.localisation.RETINASolverLocalisation.DetectionTriple')
    @patch('algorithm.localisation.RETINASolverLocalisation.Detection')
    def test_solver_none_result(self, mock_detection, mock_triple, mock_initial_guess, mock_solver):
        mock_detection.return_value = Mock()
        mock_triple.return_value = Mock()
        mock_initial_guess.return_value = {"lat": -34.9295, "lon": 138.6005, "alt": 1000}
    ...
    @patch('algorithm.localisation.RETINASolverLocalisation.DetectionTriple')
    @patch('algorithm.localisation.RETINASolverLocalisation.Detection')
    def test_detection_data_conversion(self, mock_detection, mock_triple, mock_initial_guess, mock_solver):
        mock_detection.return_value = Mock()
        mock_triple.return_value = Mock()
        mock_initial_guess.return_value = {"lat": -34.9295, "lon": 138.6005, "alt": 1000}
        mock_solver.return_value = {
    ...
    @patch('algorithm.localisation.RETINASolverLocalisation.DetectionTriple')
    @patch('algorithm.localisation.RETINASolverLocalisation.Detection')
    def test_multiple_targets(self, mock_detection, mock_triple, mock_initial_guess, mock_solver):
        mock_detection.return_value = Mock()
        mock_triple.return_value = Mock()
        mock_initial_guess.return_value = {"lat": -34.9295, "lon": 138.6005, "alt": 1000}
        mock_solver.return_value = {
    ...
    @patch('algorithm.localisation.RETINASolverLocalisation.DetectionTriple')
    @patch('algorithm.localisation.RETINASolverLocalisation.Detection')
    def test_uses_only_first_three_detections(self, mock_detection, mock_triple, mock_initial_guess, mock_solver):
        mock_detection.return_value = Mock()
        mock_triple.return_value = Mock()
        mock_initial_guess.return_value = {"lat": -34.9295, "lon": 138.6005, "alt": 1000}
        mock_solver.return_value = {
    ...
    def test_missing_radar_config(self):
        ...
        result = self.solver.process(detections_with_missing_radar, self.sample_radar_data)
